...
class PlayerCardManager
{
	...
	public:
		...
		void placeCardsOnPlayerBoard(uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs);
		void placeCardsOnPlayerBoard(uint8 num_regular_allowed);

		void addCard(Card* card, uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs);
		...
		CSC2110::ListArray<Card>* abolishSlavery(uint8 num_regular_allowed);
        ...
        void readXML(TiXmlElement* card_element, EndeavorGame* game, uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs);
};
