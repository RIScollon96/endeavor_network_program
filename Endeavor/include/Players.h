...
{
   private:
      CSC2110::ListArray<Player>* players;
	  CSC2110::ListArray<PixelPoint>* player_building_locations;
	  CSC2110::ListArray<PixelPoint>* player_track_locations;
	  CSC2110::ListArray<PixelPoint>* player_info_locations;
	  CSC2110::ListArray<PixelPoint>* player_card_locations;
	  
	  CSC2110::ListArray<HotSpot>* player_view_hot_spots;
	  CSC2110::ListArray<HotSpot>* action_token_hot_spots;
   ...
   public:
	  ...
	  void occupyCity(uint8 player_id, CSC2110::ListArray<CSC2110::Integer>* token_types, uint8 worker_cost);
      ...
      void getActivatedBuildings(CSC2110::ListArray<Building>* activated_buildings, uint8 player_id);
