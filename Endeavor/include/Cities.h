...
class Cities
{
	...
	public:
		Cities(CSC2110::ListArray<Token>* tokens, CSC2110::Permutation& permute, CSC2110::ListArray<PixelPoint>* pixel_centers, PixelDimension& pixel_dim, uint8 city_counter);
		virtual ~Cities();
