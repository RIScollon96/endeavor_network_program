...
int Region::compareRegions(Region* region_1, Region* region_2)
{
	...
	CSC2110::String* key_1 = region_1->getRegionStartKey();
	CSC2110::String* key_2 = region_2->getRegionStartKey();
	return key_1->compare(key_2);
}

int Region::compareRegionsByKeyAndRegion(CSC2110::String* key_1, Region* region)
{
	uint8 key_1_city_id = (uint8) key_1->a_to_i();
	//next line very important
	if (region->isCityInRegion(key_1_city_id)) return 0;
	
	CSC2110::String* key_2 = region->getRegionStartKey();
	return key_1->compare(key_2);
}

CSC2110::String* Region::getRegionStartKey()
{
	return &start_key;
}
...
Region::Region(EndeavorRegionType r_type, PixelXML& pixel_xml, ImageLoader* image_loader, CSC2110::ListArray<Token>* tokens, CSC2110::Permutation& permute, uint8 city_counter) : start_key(CSC2110::String::i_to_a(city_counter))
{
	region_type = r_type;
	...
	switch(region_type)
	{
		case (AFRICA):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("african_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("african_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("african_shipping");
			...
			shipping_lane = new ShippingLane(tokens, permute, shipping_centers, shipping_dim);
		...
		case (SOUTH_AMERICA):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("south_american_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("south_american_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("south_american_shipping");
		...
		case (CARIBBEAN):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("caribbean_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("caribbean_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("caribbean_shipping");
		...
		case (NORTH_AMERICA):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("north_american_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("north_american_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("north_american_shipping");
		...
		case (INDIA):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("indian_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("indian_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("indian_shipping");
		...
		case (FAR_EAST):
		{
			...
			CSC2110::ListArray<PixelPoint>* region_city_centers = pixel_xml.getPixelCentersList("far_east_cities");
			PixelDimension region_city_dim = pixel_xml.getPixelDimension("far_east_cities");
			
			CSC2110::ListArray<PixelPoint>* shipping_centers = pixel_xml.getPixelCentersList("far_east_shipping");
