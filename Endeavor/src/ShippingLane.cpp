...
uint8 ShippingLane::getPlayerPresence(uint8 player_id)
{
	...
	CSC2110::ListDoublyLinkedIterator<Ship>* shipping_lane_iter = shipping_lane->iterator();
...
ShippingLane::ShippingLane(CSC2110::ListArray<Token>* tokens, CSC2110::Permutation& permute, CSC2110::ListArray<PixelPoint>* pixel_centers, PixelDimension& pixel_dim)
{
	shipping_lane = new CSC2110::ListDoublyLinked<Ship>();
...
TiXmlElement* ShippingLane::writeXML()
{
   ...
   CSC2110::ListDoublyLinkedIterator<Ship>* ship_iter = shipping_lane->iterator();
