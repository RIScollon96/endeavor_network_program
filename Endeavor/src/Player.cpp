...
void Player::abolishSlavery(CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{
	CSC2110::ListArray<Card>* slavery_discards = player_card_manager->abolishSlavery(getPoliticsLevel());
	
	CSC2110::ListArrayIterator<Card>* abolish_iter = slavery_discards->iterator();
...
Card* Player::discard(uint8 card_id, CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{	
...
void Player::takeSelectedCard(Card* card, CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{
	industry += card->getIndustry();
	culture += card->getCulture();
	finance += card->getFinance();
...
uint8* Player::getUnactivatedBuildings()
{
   ...
   int count = 0;
   CSC2110::ListLinkedIterator<Building>* building_iter = buildings->iterator();
...
void Player::getActivatedBuildings(CSC2110::ListArray<Building>* activated_buildings)
{
   CSC2110::ListLinkedIterator<Building>* building_iter = buildings->iterator();
   while(building_iter->hasNext())
   {
...
Player::Player(uint8 p_id, wxBitmap* p_s_img, wxBitmap* p_c_img, PixelPoint& num_workers_loc, PixelDimension& marker_dim) : draw_info_font("Verdana", 10)
{
	...
	buildings = new CSC2110::ListLinked<Building>();
...
void Player::draw(wxDC&  dc, uint8 active_player, CSC2110::ListArray<PixelPoint>* track_locations, CSC2110::ListArray<PixelPoint>* info_locations)
{
	if (player_id == active_player)
	{
		...
		draw_info_font.draw(dc, CSC2110::String::i_to_a(workers).get_std_str(), info_loc->getX(), info_loc->getY());

		info_loc = info_locations->get(5);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(industry_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(2);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(culture_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(4);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(finance_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(3);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(politics_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(6);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(total_glory).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(7);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(ship_or_draw_tokens).get_std_str(), info_loc->getX(), info_loc->getY());

		info_loc = info_locations->get(8);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(occupy_or_draw_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(9);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(payment_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
		
		info_loc = info_locations->get(10);
		draw_info_font.draw(dc, CSC2110::String::i_to_a(attack_tokens).get_std_str(), info_loc->getX(), info_loc->getY());
...
TiXmlElement* Player::writeXML()
{
   ...
   CSC2110::ListLinkedIterator<Building>* buildings_iter = buildings->iterator();
...
void Player::readXML(TiXmlElement* player_element, EndeavorGame* game, CSC2110::ListArray<PixelPoint>* player_board_card_locs, CSC2110::ListArray<PixelPoint>* player_building_locations)
{	  
/*
