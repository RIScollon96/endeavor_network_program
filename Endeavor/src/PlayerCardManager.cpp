...
void PlayerCardManager::placeCardsOnPlayerBoard(uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{
	placeCardsOnPlayerBoard(num_regular_allowed);
	
	CSC2110::ListArrayIterator<Card>* card_iter = cards->iterator();
...
void PlayerCardManager::placeCardsOnPlayerBoard(uint8 num_regular_allowed)
{
   ...
   CSC2110::ListArray<Card>* placed_cards = new CSC2110::ListArray<Card>();  //will need to use this list
...
void PlayerCardManager::addCard(Card* card, uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{
   cards->add(card);
...
CSC2110::ListArray<Card>* PlayerCardManager::abolishSlavery(uint8 num_regular_allowed)
{
   CSC2110::ListArray<Card>* slavery_discards = new CSC2110::ListArray<Card>();
   if (hasSlaveryCard())
   {
...
{
   cards = new CSC2110::ListArray<Card>();
...
TiXmlElement* PlayerCardManager::writeXML()
{
    ...
    CSC2110::ListArrayIterator<Card>* cards_iter = cards->iterator();
...
void PlayerCardManager::readXML(TiXmlElement* cards_element, EndeavorGame* game, uint8 num_regular_allowed, CSC2110::ListArray<PixelPoint>* player_board_card_locs)
{
