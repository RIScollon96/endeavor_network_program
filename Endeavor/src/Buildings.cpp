...
Buildings::Buildings(PixelXML& pixel_xml, ImageLoader* image_loader)
{
   ...
   all_buildings = new CSC2110::ListArray<Building>();
   uint8 unique_id = 1;
   
   CSC2110::ListArray<PixelPoint>* building_centers = pixel_xml.getPixelCentersList("buildings_available");
   ...
   CSC2110::ListArrayIterator<PixelPoint>* point_iter = building_centers->iterator();
